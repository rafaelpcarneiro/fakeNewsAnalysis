...
the respectivelly functions that operate with these data types. Now, \textit{src} is merely the
\texttt{C} implementation of such functions, or methods if someone prefers to call them.
